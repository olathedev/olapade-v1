...
const About = () => {
  return (
    <div className="flex space-x-[10rem] py-20">
      <div className="w-1/2 flex flex-col gap-4">
        <h1 className="header text-[3em] font-poppins font-semibold">Design</h1>
      ...
      <div className="w-1/2 flex flex-col gap-4">
        <h1 className="header text-[3em] font-poppins font-semibold">
          Engineering
        </h1>
        <p className="font-josefin">
